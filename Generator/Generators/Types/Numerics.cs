...
namespace Generators
{
    ...
    public static class Numerics
    {
        ...
        public static ScalarNumericType Long => new("long", NumericCategory.Integer, 8);
        ...
        public static ScalarNumericType Uint => new("uint", NumericCategory.Unsigned, 4);
        public static ScalarNumericType Ulong => new("ulong", NumericCategory.Unsigned, 8);
        public static ScalarNumericType Float => new("float", NumericCategory.Real, 4);
        public static ScalarNumericType Double => new("double", NumericCategory.Real, 8);
        public static ScalarNumericType Decimal => new("decimal", NumericCategory.Decimal, 16);
